...
import net.zihui.zsevomob.entity.custom.IronLeeEntity;
...
public class IronLeeModel extends GeoModel<IronLeeEntity> {
    ...
    public ResourceLocation getModelResource(IronLeeEntity ironLeeEntity) {
        return new ResourceLocation(ZMobEvoMod.MOD_ID, "geo/iron_lee.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(IronLeeEntity ironLeeEntity) {
        return new ResourceLocation(ZMobEvoMod.MOD_ID, "texture/entity/iron_lee.png");
    }

    @Override
    public ResourceLocation getAnimationResource(IronLeeEntity ironLeeEntity) {
        return new ResourceLocation(ZMobEvoMod.MOD_ID, "animations/iron_lee.animation.json");
    }
}
